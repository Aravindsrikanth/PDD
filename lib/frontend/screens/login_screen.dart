          ...
          child: Container(
            ...
            child: ClipRRect(
              ...
              child: isMobile 
                ...
                : Row(children: [
                    Expanded(child: _buildLeftPanel(false)),
                    Expanded(child: _buildRightPanel(context, appState, false)),
                  ]),
            ),
          ),
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Secure access to real-time critical care data, patient monitoring, and drug dose calculations.",
            style: GoogleFonts.poppins(
              fontSize: 14,
